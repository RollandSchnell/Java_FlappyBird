...
/* This class renderes the background of the game
 * using the vertices sending them to the uniform varibles
 * and let the shaders(code) to render it
 * Note: that we give in the Level class, all the details for the background
 * position, dimension, and the texture also.
 */
...
public class Level {
	...
	/* Here we create the pipes and give them random positions and 
	 * dimensions but the width remains constant.
	 */
	...
	public void update() {
		...
		/*
		 * disable the control when collision is detected.
		 */
	...
	private void renderPipes() {
		...
		//the speed for the background moving speed
	...
	/*
	 * The method that checks if the bird hits a pipe.
	 */
	...
	/*
	 * Main render method for the Level
	 */
